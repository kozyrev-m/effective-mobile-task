...
## Поиск данных человека по идентификатору <a name="func-find">
...
Content-Type: application/json
```
## Обновление данных человека <a name="func-update">
...
## Удаление данных человека <a name="func-delete">
...

{
    ...
    // Пагинация
    "page":     <НОМЕР_СТРАНИЦЫ>,         // по умолчанию 1
    "per_page": <КОЛИЧЕСТВО_НА_СТРАНИЦУ>, // по умолчанию 10
